...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
		<div class="container">
			<a class="navbar-brand js-scroll-trigger" href="#page-top">Commerceo</a>
	...
	<header class="masthead">
		<div class="container">
			<div class="intro-text">
				<div class="intro-lead-in">Welcome To Our Commerceo!</div>
		...
		<div class="container">
			...
			<div class="row text-center">
				<div class="col-md-4">
					...
					<h4 class="service-heading">Customs Billing</h4>
				...
				<div class="col-md-4">
					...
					<h4 class="service-heading">Customs Filing</h4>
					<p class="text-muted">Lorem ipsum dolor sit amet, consectetur
						adipisicing elit. Minima maxime quam architecto quo inventore
						harum ex magni, dicta impedit.</p>
				</div>
				<div class="col-md-4">
					...
					<h4 class="service-heading">Record Storage</h4>
					<p class="text-muted">Lorem ipsum dolor sit amet, consectetur
						adipisicing elit. Minima maxime quam architecto quo inventore
						harum ex magni, dicta impedit.</p>
				</div>
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a class="portfolio-link" data-toggle="modal"
						...
						</div> <img class="img-fluid" src="resources/img/portfolio/customs1.jpg"
						alt="">
					</a>
					<div class="portfolio-caption">
						<h4>CustomsComrade</h4>
						<p class="text-muted">CustomsClearence</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a class="portfolio-link" data-toggle="modal"
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="team-member">
						<img class="mx-auto rounded-circle" src="resources/img/face/7.jpg"
							alt="Prashant">
						...
						<ul class="list-inline social-buttons">
							...
							<li class="list-inline-item"><a
								href="www.linkedin.com/in/prashantmi/"> <i
				...
				<div class="col-sm-4">
					<div class="team-member">
						<img class="mx-auto rounded-circle"
							src="resources/img/team/10.jpg" alt="">
					...
					<div class="row">
						<div class="col-lg-8 mx-auto">
							<div class="modal-body">
								...
								<h2 class="text-uppercase">CustomsComrade</h2>
								<p class="item-intro text-muted">A Comrade For Customs
									Agents And Brokers.</p>
								<img class="img-fluid d-block mx-auto"
									src="resources/img/portfolio/customs1.jpg" alt="">
								<p>A Billing, Filing And Record Storing Software Service For
									Customs Clearence India An Aplication For Customs Agents And
									Brokers</p>
								<ul class="list-inline">
									<li>Application: CustomsComrade</li>
									<li>Clients: Customs Agents And Brokers</li>
									<li>Catogory: Billing And Filing</li>
								</ul>
